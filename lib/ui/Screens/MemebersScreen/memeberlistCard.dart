  ...
  Widget build(BuildContext context) {
    ...
    child: Container(
      ...
      title:  Padding(
        ...
        child: Text(  "Memeber name", style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold),),
      ) ,
     // : Text("N/A",style: AppTypographyStyles.smallTextStyleNotVailable), 
      ...
      subtitle: Padding(
        ...
        child: Column(
         crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
           //  items.dcNo !=null ?
              Text("Some detail about memebr", style: AppTypographyStyles.smallTextStyle.apply(color:Colors.black54), ) ,
      ...
      //     Icon(Icons.keyboard_arrow_right, color: Colors.white, size: 30.0),
          onTap: (){
             ...
             Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => MemberDetailScreen())
           );
